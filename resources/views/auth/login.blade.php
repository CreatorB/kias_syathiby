...
<head>
  ...
  <meta name="description" content="KIAS - Kursus Ilmu bahasa Arab & Syar'i">
  ...
  <link rel="stylesheet" type="text/css"
    href="{{ asset('style/app-assets/css/core/menu/menu-types/vertical-menu.min.css') }}">
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click"
  data-menu="vertical-menu-modern" data-col="blank-page" style="font-family: Poppins,serif">
  <!-- BEGIN: Content-->
        ...
        <div class="auth-wrapper auth-cover">
          <div class="auth-inner row m-0">
            <!-- Brand logo--><a class="brand-logo" href="/">
              ...
              <h2 class="brand-text ms-1" style="color:#359090">KIAS</h2>
            </a>
            <!-- /Brand logo-->
            <!-- Left Text-->
            <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
              <div class="w-100 d-lg-flex align-items-center justify-content-center px-5">
                <img class="img-fluid" src="{{ asset('landing/images/banner/quran-banner.webp') }}" alt="Login V2" />
              </div>
            </div>
            <!-- /Left Text-->
            <!-- Login-->
            <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
              <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                ...
                <p class="card-text mb-2">Kursus Ilmu bahasa Arab & Syar'i</p>
                <!--PESAN GAGAL LOGIN-->
                ...
                <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                  ...
                  <div class="mb-1">
                    ...
                    <input class="form-control @error('email') is-invalid @enderror" @if(\Cookie::has('saveuser'))
                    value="{{ \Cookie::get('saveuser') }}" @endif type="text" name="email"
                      placeholder="email@example.com atau 08xxxx" tabindex="1" />
                  </div>
                  ...
                  <div class="mb-1">
                    ...
                    <div class="input-group input-group-merge form-password-toggle">
                      <input class="form-control form-control-merge @error('password') is-invalid @enderror"
                        @if(\Cookie::has('savepwd')) value="{{ \Cookie::get('savepwd') }}" @endif id="password"
                        type="password" name="password" aria-describedby="login-password" tabindex="2" />
                  ...
                  <div class="mb-1">
                    <div class="form-check">
                      <input class="form-check-input" id="remember-me" name="simpanpwd" type="checkbox" tabindex="3"
                        @if(\Cookie::has('saveuser')) checked @endif />
