<div>
            ...
            <x-cards.basic-card>
                ...
                <div class="row">
                    <div class="col-12 table-responsive">
                                ...
                                @forelse ($this->dataPaginator as $pendaftar)
                                    <tr wire:key='table-{{ $pendaftar->id }}'>
                                        ...
                                        <td>
                                            ...
                                            <x-buttons.outline :color="$pendaftar->status_transfer == \App\Providers\StatusProvider::TRANSFER_VALID ? 'success' : 'warning'" class="btn-icon btn-sm" data-bs-toggle="modal" data-bs-target="#modalVerifikasi" wire:click='setIdPendanfar({{ $pendaftar->id }})'>
                                            ...
                                            <x-buttons.outline color="danger" class="btn-icon btn-sm" wire:click='setIdPendanfarHapus({{ $pendaftar->id }})'>
                        ...
                        {{ $this->dataPaginator->links(data: ['scrollTo' => false]) }}
                    </div>
                </div>
                <!--#Tabel Data Pendaftar-->
            </x-cards.basic-card>
    ...
    <script data-navigate-once>
        ...
        document.addEventListener('hapus-success', function() {
            'use strict';
            var isRtl = $('html').attr('data-textdirection') === 'rtl';
