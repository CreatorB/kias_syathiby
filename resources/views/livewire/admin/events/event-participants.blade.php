                    ...
                    <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-1">
                            <button type="button"
                                ...
                                wire:confirm="Yakin ingin mereset password SEMUA peserta di event ini ke 'bismillah'?"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button wire:click="resetPassword({{ $registration->id }})"
                                                wire:confirm="Reset password ke 'bismillah'?"
                ...
                <div class="modal-body">
                    ...
                    <form wire:submit="addParticipant">
                        ...
                        <div class="mb-1">
                            ...
                            <input type="password" wire:model="manualPassword" class="form-control" value="bismillah">
                            @error('manualPassword') <span class="text-danger small">{{ $message }}</span> @enderror
                        </div>
                        <div class="mb-1">
                            <label class="form-label">Konfirmasi Password</label>
                            <input type="password" wire:model="manualPasswordConfirmation" class="form-control" value="bismillah">
