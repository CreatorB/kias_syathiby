...
<body>
          ...
          <div class="card-body">
            ...
            <form class="mb-3" action="{{ route('login') }}" method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="email" name="email" autofocus @if(\Cookie::has('saveuser'))
                value="{{ \Cookie::get('saveuser') }}" @endif />
              </div>
              ...
              <div class="mb-1">
                <label><em>Checklist <b>"Simpan Password"</b> untuk masuk kembali tanpa menuliskan <b>Username dan
                      Password</b> </em></label>
              </div>
              <div class="mb-3">
                <div class="form-check">
                  <input class="form-check-input" name="simpanpwd" type="checkbox" id="remember-me"
  ...
  <div class="text-center py-3">
    <small style="color: #6c757d; font-size: 12px;">
      Made with <span style="color: #359090;">&hearts;</span> by
      <a href="https://syathiby.github.io" target="_blank"
        style="color: #359090; text-decoration: none; font-weight: 500;">IT Syathiby</a>
      2024
      <span style="margin: 0 6px; color: #ccc;">|</span>
      <a href="https://github.com/CreatorB/kias_syathiby" target="_blank"
        style="color: #6c757d; text-decoration: none;">
        <i class="ti ti-brand-github"></i> Open Source
      </a>
    </small>
  </div>
