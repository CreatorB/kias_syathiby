        ...
        <ul class="nav navbar-nav align-items-center d-lg-none d-xl-none">
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                    ...
                    <div class="user-nav d-flex"
                        style="display: flex !important; flex-direction: column !important; align-items: flex-end !important; margin-right: 0.5rem !important;">
                        <span class="user-name fw-bolder"
                            style="color: #6e6b7b !important; display: block !important;">{{ $nama_depan ?? Auth::user()->name ?? 'User' }}
                            {{ $nama_belakang ?? '' }}</span>
