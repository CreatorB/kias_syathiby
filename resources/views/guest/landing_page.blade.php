      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-5 col-md-12 mt-5 mt-lg-0 ms-auto">
            ...
            <a class="btn btn-dark wow fadeInUp" data-wow-duration="3s" data-wow-delay="0.5s" href="#program"
              data-text="Info"> <span>P</span><span>r</span><span>o</span><span>f</span><span>i</span><span>l</span>
            </a>
          </div>
        </div>
      </div>
  ...
  <div class="page-content">
      ...
      <div class="container">
        <div class="row text-center">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="section-title">
              <h2 class="title">Asatidzah pengajar <span class="text-theme">berkompeten dan berkualitas</span> sesuai
                bidangnya</h2>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <div class="owl-carousel no-pb" data-dots="false" data-items="3" data-md-items="2" data-sm-items="1"
              data-autoplay="true">
              @foreach ($pengajar as $item)
                <div class="item">
                  <div class="team-member style-3">
                    <div class="team-images">
                      <img class="img-fluid rounded box-shadow" src="{{ asset('landing/images/banner/avatar.webp') }}"
                        alt="">
    ...
    <section class="p-0 text-center wow fadeInUp mt-5" data-wow-duration="2s">
      <div class="container">
        <div class="row text-center">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="section-title">
              <h2 class="title">Mengapa Harus Belajar Di <span class="text-theme">KIAS?</span></h2>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row subscribe-inner align-items-center">
          ...
          <div class="col-md-6 col-sm-12 mt-3 mt-md-0">
            ...
            <a class="btn btn-dark wow fadeInUp" data-wow-duration="3s" data-wow-delay="0.5s" href="/profil-kias"
              data-text="Baca Profil">
    ...
    <section id="kontak" class="contact-info p-0 z-index-1">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-4 col-md-12">
            <a href="https://kias.syathiby.id" target="_blank">
              <div class="contact-media"> <i class="flaticon-paper-plane"></i><span>Website</span>
                <p>https://kias.syathiby.id</p>
              </div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 mt-5 mt-lg-0">
            <div class="contact-media"> <i class="flaticon-email"></i><span>Email</span>kias.syathiby@gmail.com
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mt-5 mt-lg-0">
        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <div class="map iframe-h-2">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.9897975071876!2d106.95983527416803!3d-6.395315662549102!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69948a9e3056b3%3A0x88fed5dbb38dd881!2sLembaga%20Pendidikan%20Takhassus%20Al-Barkah!5e0!3m2!1sen!2sid!4v1682567922105!5m2!1sen!2sid"
