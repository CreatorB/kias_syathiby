...
<div class="container">
    ...
    <div class="col-lg-12 col-md-12 mt-3 mt-lg-0">
        ...
        <p class="lead mb-3 text-black">
            Segala puji bagi Allah yang telah mengajar manusia dengan perantaraan pena, mengajari manusia apa yang tidak diketahuinya.
            Sesungguhnya menuntut ilmu merupakan ibadah dan pendekatan diri yang paling agung dari seorang hamba kepada Rabbnya. <br><br>
        ...
        <p class="lead mb-3 text-black">
            Setelah mengikuti proses pendidikan dengan benar maka peserta diharapkan memiliki kompetensi:<br>
            1. Mengenal nilai-nilai Islam serta mampu mempraktikannya dalam kehidupan <br>
            2. Mamiliki dasar-dasar Ilmu Tajwid <br>
            3. Memiliki dasar-dasar Bahasa Arab <br>
            4. Memiliki dasar-dasar Ulumu Syar’iah <br>
            5. Memiliki dasar-dasar Ulumu Al-Hadits <br>
            6. Mampu membaca kitab para ulama yang berbahasa Arab <br>
            7. Mengetahui sumber rujukan ilmiah dengan benar <br>
            8. Mengetahui dasar-dasar pengambilan hukum dengan shohih <br>
            9. Mampu mengamalkan ilmu <br>
            10. Mampu mendakwahkan ilmu dengan shohih <br>
            11. Memiliki akhlak yang mulia. <br>
        </p>
        ...
        <p class="lead mb-3 text-black">
            ...
            1. Terpadu dan Tematik; segala hal yang dipelajari saling terkait <br>
            2. Terintegrasi dan Kontekstual; segala hal yang dipelajari saling terkait dan dekat dengan kehidupan sehari-hari <br>
            3. Kreatif dan Inovatif; melalui kegiatan yang menarik yang dapat membangkitkan rasa ingin tahu, memotivasi  untuk berpikir dan menemukan hal-hal baru. <br>
            4. Inquiry; memelihara keingintahuan melalui keteram-pilan proses yang eksploratif dengan belajar melalui praktek di lapangan dimana lingkungan alam dan sekitar menjadi sumber belajar. <br>
            5. Konstruktivisme; belajar dari apa yang telah diketahui oleh santri secara bertahap dari yang sederhana ke kompleks. <br>
            6. Santri Active Learning (SAL); belajar aktif atau belajar yang berpusat pada santri sesuai dengan kebutuhan perkembangan santri dalam segala aspek. <br>
